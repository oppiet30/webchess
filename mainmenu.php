...
*/
	...
	if (isset($_POST['ToDo'])) {
		...
		/* hand the POST action off to the controller (faithful extraction of the
		   former inline switch; see lib/WebChess/Http/MainmenuController.php) */
		$actionOutcome = (new \WebChess\Http\MainmenuController())->handle($postTodo);
		$tmpNewUser = $actionOutcome['tmpNewUser'];
		$errMsg = $actionOutcome['errMsg'];
	}
